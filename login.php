            ...
            if ($stmt->execute()) {
                ...
                if ($stmt->rowCount() == 1) {
                    if ($row = $stmt->fetch()) {
                        ...
                        // Compare the entered password with the stored one (no hashing)
...
<head>
    ...
    <link rel="icon" href="img/logo/manthan.png" sizes="32x32" type="image/png">
        ...
        <div class="section jumbotron mb-0 h-100">
            ...
            <div class="container d-flex flex-column justify-content-center align-items-center h-100">
                ...
                <div class="wrapper my-0 pt-3 bg-white w-50 text-center">
                    <img src="img/logo/manthan.png" alt="dev culture logo" style="width: 100px;height: auto;">
                </div>
