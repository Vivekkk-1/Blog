        ...
        <div class="jumbotron text-center p-0 mb-0">
            <div class="bg-div px-5 d-flex align-items-center">
                ...
                <div class="text-left w-50">
                    <h1 class="display-4 text-white">Welcome to Manthan!!</h1>
                    <h2 class="display-5 text-white">Discover Manthan tutorial and articles that you can read completely for free!</h2>
